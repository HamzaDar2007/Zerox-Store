...
export class CreateLoyaltyTierDto {
  ...
  @ApiProperty({ description: 'Minimum points required for this tier', default: 0 })
  @IsInt()
  @Min(0)
  minPoints: number;
  ...
  @ApiPropertyOptional({ description: 'Points earn multiplier (0.5-10)', default: 1.0 })
  @IsOptional()
  @IsNumber()
  @Min(0.5)
  @Max(10)
  ...
  @ApiPropertyOptional({ description: 'Color hex code (e.g., #FF5733)', maxLength: 7 })
  @IsOptional()
  @IsString()
  @MaxLength(7)
