...
export class NotificationsController extends BaseController {
  constructor(private readonly notificationsService: NotificationsService) { super(); }
  ...
  findAll(
    ...
    return this.handleAsyncOperation(this.notificationsService.findAll(user.id, { isRead, type, page, limit }));
  }

  @Get('unread-count')
  @ApiOperation({ summary: 'Get unread notification count' })
  getUnreadCount(@CurrentUser() user: User) {
    return this.handleAsyncOperation(this.notificationsService.getUnreadCount(user.id));
  }
  ...
  markAllAsRead(@CurrentUser() user: User) {
    return this.handleAsyncOperation(this.notificationsService.markAllAsRead(user.id));
  }
  ...
  getPreferences(@CurrentUser() user: User) {
    return this.handleAsyncOperation(this.notificationsService.getPreferences(user.id));
  }
...
export class NotificationTemplatesController extends BaseController {
  ...
  create(@Body() dto: CreateNotificationTemplateDto) {
    return this.handleAsyncOperation(this.notificationsService.createTemplate(dto));
  }

  @Patch(':id')
  @ApiOperation({ summary: 'Update notification template' })
  @Permissions('notifications.update')
  update(@Param('id', ParseUUIDPipe) id: string, @Body() dto: UpdateNotificationTemplateDto) {
    return this.handleAsyncOperation(this.notificationsService.updateTemplate(id, dto));
  }
}
